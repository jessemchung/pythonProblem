...
# python3 -m venv my-venv to create the my-venv folder and local
# source my-venv/bin/activate to activate the local stuff for use in import
# Will also allow things like pip3 and stuff
# deactivate to leave that area
def main(url):
